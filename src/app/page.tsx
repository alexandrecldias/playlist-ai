    ...
    <div className="min-h-screen flex items-center justify-center bg-zinc-50 dark:bg-black font-sans">
      <main className="w-full max-w-3xl p-8">
        <div className="bg-white dark:bg-zinc-900 shadow-md rounded-lg p-10">
          ...
          <p className="mt-4 text-zinc-600 dark:text-zinc-300">Crie playlists inteligentes e personalize suas recomendações – autentique-se com Spotify para começar.</p>
          ...
          <p className="mt-6 text-sm text-zinc-500">Ao entrar, será solicitado acesso às permissões necessárias para gerenciar suas playlists.</p>
        </div>
      </main>
    </div>
  );
